...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: `${process.env.NEXT_PUBLIC_APP_URL}/kids-cycle`,
    },
}
                    ...
                    <div className="flex items-center justify-between">
                        <div className="relative py-14 md:py-16">
                            <div className="text-3xl sm:text-4xl/tight md:text-6xl/tight xl:text-[70px]/[84px]">
                                <h1 className="font-bold">Kids Bikes</h1>
                        ...
                        <div className="relative hidden lg:block xl:h-96 2xl:h-[500px]">
                            <Image
                                src="/images/kids-banner-cycle.png"
                                alt="Cycle"
                    ...
                    __html: `{
                        ...
                        "breadcrumb": {
                            ...
                            "itemListElement": [{
                                ...
                                "position": 2,
                                "name": "Kids cycle",
                                "item": "${process.env.NEXT_PUBLIC_APP_URL}/kids-cycle"
                            }]
                        }
                    }`,
                }}
