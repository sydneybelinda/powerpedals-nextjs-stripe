...
export default async function SuccessPage({ searchParams }) {
  ...
  return (
    <div id="payment-status">
      ...
      {paymentIntent && <Link href={`https://dashboard.stripe.com/payments/${paymentIntentId}`} id="view-details" target="_blank">View details
      ...
      <Link id="retry-button" href="/">Test another</Link>
    </div>
  );
}