...
import ClearCart from '../../../components/custom/clear-cart'
...
export default async function SuccessPage({ searchParams }) {
  ...
  return (
    <div id="payment-status">
      ...
      {paymentIntent && <Link href={`https://dashboard.stripe.com/payments/${paymentIntentId}`} id="view-details" className='display-none' target="_blank">View details
      ...
      <Link id="retry-button" className='display-none' href="/">Test another</Link>
    </div>
  );
}
