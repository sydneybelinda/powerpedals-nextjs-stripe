...
export default function PrivacyPolicy() {
    return (
        <>
            <div className="relative mx-auto w-full bg-[#F6F6F6] py-12 text-center lg:py-20 px-4">
                    ...
                    <li>
                        ...
                        <div>
                            ...
                            <p>
                                ...
                                store for your own personal or commercial
                                purposes. You may customize or adapt the
                                Products as needed for your use, but you may not
                                redistribute or resell them as standalone items.
                            </p>
                        </div>
                        <div>
