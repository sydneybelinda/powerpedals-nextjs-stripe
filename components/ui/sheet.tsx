    ...
    (
        ...
        <SheetPortal>
            ...
            >
                {children}
                {isShowCloseButton && (
                    <SheetPrimitive.Close className="ring-offset-background transition-opacityfocus:outline-none data-[state=open]:bg-secondary absolute right-4 top-6 rounded-xs hover:opacity-70 disabled:pointer-events-none">
